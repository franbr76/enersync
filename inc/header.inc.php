  ...
  <div class="container">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><img src="image/logo.png" style="width: 100px"
            alt="Logo da Enersync"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item"><a class="nav-link" href="planejar.php">Planejar Viagem</a></li>
            <li class="nav-item"><a class="nav-link" href="compararVeiculo.php">Comparar Veiculos</a></li>
            <li class="nav-item"><a class="nav-link" href="pecas.php">Comprar Peças</a></li>
          ...
          <div class="text-end px-5">
            ...
            <?php if ($usuario_logado): ?>
              <button class="btn btn-danger rounded-pill px-3 " type="button"
                onclick="abrirModalConfirmacao('Encerrar Sessão', 'Tem certeza que deseja sair?', () => window.location.href = 'sair.php')">
                Sair
              </button>
            <?php else: ?>
